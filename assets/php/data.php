...
function slides(){
    ...
    $slides[] = array(
        ...
        'product_img'=>'http://grapevine.co.za/wp-content/uploads/2018/11/120629.jpg',
        'company_logo'=>'https://grapevine.co.za/wp-content/uploads/2017/05/Loreal-Luxe-Logo.jpg'
    );
    $slides[] = array(
        'prev'=>'L&rsquo;Oréal Luxe',
    ...
    $slides[] = array(
        ...
        'product_img'=>'https://grapevine.co.za/wp-content/uploads/2018/11/LOCKUP_PS4HZD_packshot.jpg',
    ...
    $slides[] = array(
        ...
        'next'=>'Smart media',
        'comp_title'=>'L&rsquo;Oréal Luxe',
        'paragraph'=>'&ldquo;Just another mail to say thank you so much to the Grapevine Team for such a well-timed, beautiful execution. The Grapevine Team are incredible and a dream to work with.&rdquo;',
        'person'=>'Tayla King',
        'person_info'=>'Junior Product Manager',
        'product_img'=>'http://grapevine.co.za/wp-content/uploads/2018/11/LorealConsumerGarnierNutrisse.jpg',
        'company_logo'=>'https://grapevine.co.za/wp-content/uploads/2017/05/Loreal-Luxe-Logo.jpg'
    );
    $slides[] = array(
        'prev'=>'L&rsquo;Oréal Luxe',
        'next'=>'COTY',
        'comp_title'=>'Smart media',
        'paragraph'=>'&ldquo;I have just been through the 2 files of the installation, and together with my own wanderings and those of my colleagues today would like to compliment you and the team for the great job in getting this project up and running in our stores. I appreciate all the work you all did and I look forward to a great promo.&rdquo;',
        'person'=>'Mark Uria',
        'person_info'=>'CEO',
        'product_img'=>'http://grapevine.co.za/wp-content/uploads/2018/11/DC-Healthy-Living-3.jpg',
        'company_logo'=>'http://grapevine.co.za/wp-content/uploads/2018/11/Smart-Media-Logo.png'
    );
    $slides[] = array(
        'prev'=>'Smart media',
        'next'=>'Woolworths',
        'comp_title'=>'COTY',
        'paragraph'=>'&ldquo;"We at COTY received great assistance from the Grapevine Team on our Burberry Her executions in Woolworths. With short lead times due to Global approvals, the team still managed to execute beautifully on time in-store."&rdquo;',
        'person'=>'Carmen van Wyk',
        'person_info'=>'Trade Marketing | Luxury South Africa',
        'product_img'=>'http://grapevine.co.za/wp-content/uploads/2018/11/Burberry-Her-Testimonial-1-2.png',
        'company_logo'=>'http://grapevine.co.za/wp-content/uploads/2018/11/COTY_LOGO_2016.png'
    );
    $slides[] = array(
        'prev'=>'COTY',
        'next'=>'Dischem',
        'comp_title'=>'Woolworths',
        'paragraph'=>'&ldquo;Our Head of VM and Store Design has been very complimentary on the Grapevine Visuals of late, he says they are looking consistent and attractive&rdquo;',
        'person'=>'Kerry White',
        'person_info'=>'Creative Manager',
        'product_img'=>'http://grapevine.co.za/wp-content/uploads/2018/11/Woolworths-Testimonial.jpg    ',
        'company_logo'=>'https://grapevine.co.za/wp-content/uploads/2017/06/Woolworths_logotype_2.png'
    );
    ...
    $slides[] = array(
        ...
        'next'=>'Foschini',
        'comp_title'=>'Dischem',
        'paragraph'=>'&ldquo;I must compliment you on the window posters. They are beautiful.&rdquo;',
        'person'=>'Christo Behr',
        'person_info'=>'Store Manager',
        'product_img'=>'http://grapevine.co.za/wp-content/uploads/2018/11/dc-christmas.png',
        'company_logo'=>'http://grapevine.co.za/wp-content/uploads/2018/11/dischem_3.png'
    );
    ...
    $slides[] = array(
        ...
        'next'=>'Bacher &amp; Co',
        'comp_title'=>'Foschini',
        'paragraph'=>'&ldquo;Thanks I was in stores last week and they looked great!&rdquo;',
        'person'=>'Zainab Mohamed',
        'person_info'=>'Brand Manager',
        'product_img'=>'http://grapevine.co.za/wp-content/uploads/2018/11/scandal.png',
        'company_logo'=>'http://grapevine.co.za/wp-content/uploads/2018/11/logo_foschini-1.png'
    );
